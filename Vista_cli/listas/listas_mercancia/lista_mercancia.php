...
<body>
	<section id="container">
		...
		<a href="../../Formularios/Formulariosart/crear_mercancia.php" class="btn_new">Crear nuevo artículo</a>

		<form action="buscar_mercancia.php" method="get" class="form_search">
			<input type="text" name="busqueda" id="busqueda" placeholder="Buscar">
			<input type="submit" value="Buscar artículo" class="btn_search">
		</form>
	<table>
		<tr>
				<th>Código</th>
			  ...
			  $result = mysqli_num_rows($query);
				...
				?>
					<tr>
						...
						<td><?php echo "<a  href=../../Formularios/Formulariosart/img/files/ver_img.php?id=".$row["nom_img"].">".$row["nom_img"]."</a>";?></td>
