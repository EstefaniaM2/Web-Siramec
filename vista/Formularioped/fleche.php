    ...
    <section class="form_wrap">
        ...
        <form action="" method="post" class="form_contact">
            ...
            <div class="user_info">
                ...
                <select name="descr">
                    <?php
                    $query = mysqli_query($conexion,"SELECT nom_art FROM articulo where nom_art='leche' ");
                ...
                <?php 
                    $query = mysqli_query($conexion,"SELECT pre_art,nom_art FROM articulo where nom_art='leche' ");
                    $result = mysqli_num_rows($query);
