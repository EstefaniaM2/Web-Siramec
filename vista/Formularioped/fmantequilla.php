    ...
    <section class="form_wrap">
        ...
        <form action="" method="post" class="form_contact">
            ...
            <div class="user_info">
                ...
                <select name="descr">
                    <?php
                    $query = mysqli_query($conexion,"SELECT nom_art FROM articulo where nom_art='mantequilla' ");
                    $result = mysqli_num_rows($query);

                        if($result){
                            while($row=mysqli_fetch_assoc($query)){
                    ?>
                        <option><?php echo $row["nom_art"];?></option>  
                        <?php
                            }
                        }
                        ?>
                ...
                <?php 
                    $query = mysqli_query($conexion,"SELECT pre_art,nom_art FROM articulo where nom_art='mantequilla' ");
                    $result = mysqli_num_rows($query);

                        if($result){
                            while($row=mysqli_fetch_assoc($query)){
                    ?> 
                   <option value=""><?php echo $row["pre_art"];?></option> 
                    <?php
                            }
                        }
                        ?>
