                ...
                <div class="row h-100">
                    <div class="col-12 h-100">
                        <div class="header-content h-100 d-flex align-items-center justify-content-between">
                            ...
                            <i class="fecha">Colombia, <?php echo fechaC(); ?></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp <span> <?php echo $_SESSION['user'] ?> - <span><?php echo $_SESSION['rol'] ?>-Destinatario</span></span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="sali.php" title="Salir"><i class="fas fa-power-off"></i></a>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-teachers-area text-center mb-100 wow fadeInUp" data-wow-delay="400ms">
                        ...
                        <div class="teachers-thumbnail">
                            <img src="img/bg-img/teaa1.jpg" alt="">
                        </div>
                        <!-- Meta Info -->
                        <div class="teachers-info mt-30">
                        <a href="Formularioped/index.php"><h5>Leche</h5></a>
                          <!-- <button href="Formularioped/index.php"><span>Mas vendido #1</span></button>--> 
                         <a href="Formularioped/index.php">
                           <button class='btn btn-warning btn-block'>Haz tu pedido!</button>
                           </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-teachers-area text-center mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <!-- Thumbnail -->
                        <div class="teachers-thumbnail">
                            <img src="img/bg-img/teaa2.jpg" alt="">
                        </div>
                        <!-- Meta Info -->
                        <div class="teachers-info mt-30">
                        <a href=""><h5>Cerveza pilsen</h5></a>
               ...
               <a href="" > <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-teachers-area text-center mb-100 wow fadeInUp" data-wow-delay="600ms">
                        <!-- Thumbnail -->
                        <div class="teachers-thumbnail">
                           <a href=""> <img src="img/bg-img/teaa3.jpg" alt=""></a>
                        </div>
                        <!-- Meta Info -->
                        <div class="teachers-info mt-30">
                           <a href=""><h5>Mantequilla</h5></a>
                           <a href="Formularioped/index.php">
                           <button class='btn btn-warning btn-block'>Haz tu pedido!</button>
                           </a>
                        </div>
               ...
               <a href="" > <div class="col-12 col-sm-6 col-lg-3">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-teachers-area text-center mb-100 wow fadeInUp" data-wow-delay="700ms">
                        <!-- Thumbnail -->
                        <div class="teachers-thumbnail">
                            <img src="img/bg-img/teaa4.jpg" alt="">
                        </div>
                        <!-- Meta Info -->
                        <div class="teachers-info mt-30">
                            <h5>Galletitas</h5>
