...
<div class="container-fluid">
        <div class="col-me-12">
            ...
            <div class="col-md-12"><br>
                    <h2 class="text-center">PRODUCTOS SELECCIONADOS</h2><br>
                    <h6 class="titulo" ><a href="producto.php">carro de compras</a></h6>
                    <?php 
                    ...
                    if(!empty($_SESSION['cart'])) {
                        ...
                        <tr>
                        <td>
                        <a target='blank' href='../index.php'>concretar compra</a><td>
                        </tr>
                        ";
