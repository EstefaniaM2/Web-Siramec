        ...
        $permitidos = array("image/png", "image/jpg","image/jpeg");
            ...
            $determinar_img = $_FILES['foto']['name'];
                ...
                if (!strpos($determinar_img, ' ')){
                    ...
                    $ruta = "../../../Vista_cli/Formularios/Formulariosart/img/files/";
                    opendir($ruta);
            ...
            <section class="cantact_info">
                ...
                <div id="Layer1" >
                    ...
                    <a><?php echo isset($error) ? $error : '';?><br></a>
                       ...
                       <a href="../../listas/listas_mercancia/lista_mercancia.php" id="btnsend">Cancelar</a>
