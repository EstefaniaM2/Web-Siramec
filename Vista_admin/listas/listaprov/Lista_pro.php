...
<body>
	<section id="container">
		...
		<a href="../../../Vista_cli/Formularios/Formulariopro/index.php" class="btn_new">Crear Usuario</a>
	...
	<table>
		<tr>
			...
			<?php 
			  ...
			  $query = mysqli_query($conexion," SELECT nit_prov, nom_prov, dir_prov, ciu_prov, tel_prov, email_prov FROM proveedor");
