<?php
	...
	if(!empty($_POST['registrar'])){
        ...
        $insertar = "INSERT INTO articulo(cod_art, nom_art, tam_art, pre_art, cant_art, tipo_art,nom_img, fecha_entra, cod_alm1, nit_cli1) VALUES ('$codigo', '$nombre', '$tamaño', '$precio', '$cantidad', '$tipo','$nom_img', '$fecha_entrada', '$codigo_almacen', '$nit_cliente')";
